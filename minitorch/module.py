...
class Module:
    ...
    def named_parameters(self) -> Sequence[Tuple[str, Parameter]]:
        ...
        for child_name in self._modules:
            child_params = self._modules[child_name].named_parameters()
            for param in child_params:
                res.append((child_name + '.' + param[0], param[1]))
        return res
    ...
    def parameters(self) -> Sequence[Parameter]:
        ...
        for child_name in self._modules:
            res += self._modules[child_name].parameters()
        return res
